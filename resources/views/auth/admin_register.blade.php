@extends('layouts.app', ['class' => 'register-page', 'page' => __('Register admin.'), 'contentClass' => 'register-page', 'pageSlug' => 'register-admin'])
    ...
    <div class="row">
        ...
        <div class="col-md-7 mr-auto">
            <div class="card card-register card-white">
                ...
                <form class="form" method="post" action="{{ route('postRegisterAdmin') }}">
                    @csrf
